...
class XGB():
    ...
    def grid_search(self):
        ...
        xgb = XGBClassifier()
        xgb_grid = RandomizedSearchCV(xgb, param_distributions= params, n_iter=3, scoring="f1", cv=3, refit=True, random_state=self.random_state)
        xgb_grid.fit(train_X, train_Y, early_stopping_rounds=50, eval_metric=evaluate_macroF1_lgb, eval_set=[(val_X, val_Y)])
